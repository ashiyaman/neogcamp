          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                luxurious house. Explore the rich history and the beauty of the
          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                pristine beaches, take a dig in the private pool and soak up in
                the sun in this coastal retreat.
              </p>
              <p className="card-text">
                <small className="text-body-secondary">
        ...
        <div className="row">
          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              <p className="card-text">
                {' '}
                Enjoy you stay in this stylish loft house situated in the heart
