    ...
    <>
      ...
      <main className="container my-4">
        ...
        <section className="my-2">
          ...
          <p>
            Enjoy you stay in this stylish loft house situated in the heart of
        ...
        <section className="my-2">
          ...
          <p>
            Relax and unwind in this beachfront villa. Wake up to panaromic
            beach views, take a dip in the private pool and enjoy seamless
