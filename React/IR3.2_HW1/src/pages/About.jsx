  ...
  return (
    <>
      ...
      <div className="container my-4">
        ...
        <p>
          Our team of food enthusiasts, chefs and reviewers collaborate to
        ...
        <p>
          ...
          gems, iconic eateries and innovative culinary trends. wheteher you're
          a seasoned foodie or an adventurous diner, we invite you to explore,
          indulge and savor the flavors of world with us. Thank you for being
