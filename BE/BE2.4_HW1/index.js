...
//Find and delete a restaurant by id
...
//deleteRestaurantById("677fb0f1f44244573b34ba35")

//Find restaurant and delete from db

const deleteRestaurantByName = async(restaurantName) => {
    try{
        const deletedRestaurant = await Restaurants.findOneAndDelete({name: restaurantName})
        console.log(deletedRestaurant)
    }
    catch(error){
        throw error
